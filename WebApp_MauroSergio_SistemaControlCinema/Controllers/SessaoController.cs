...
namespace WebApp_MauroSergio_SistemaControlCinema.Controllers
{
    public class SessaoController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SessaoId,DataHoraInicio,DataHoraFim,ValorInteira,ValorMeia,Encerrada,SalaId")] Sessao sessao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SessaoId,DataHoraInicio,DataHoraFim,ValorInteira,ValorMeia,Encerrada,SalaId")] Sessao sessao)
        {
            if (ModelState.IsValid)
            {
